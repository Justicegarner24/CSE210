...
class Program
{
    ...
    {   
        ...
        Address address1 = new Address ("3552 E. Leihm Lane", "Idaho Falls", "ID", "USA");
        Customer customer1 = new Customer("Guy Beanito", address1);
        ...
        Customer customer2 = new Customer("Jon kropp", address2);

        double order2ShippingCost = customer2.GetShippingCost();

        Product order2Product1 = new Product("Coconut", "4260", 2.00, 5);
        Product order2Product2 = new Product("Mango", "4959", 1.00, 4);
